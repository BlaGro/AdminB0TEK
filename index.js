...
bot.on("message", async message => {
  ...
  if(cmd === `${prefix}pomoc`){
    ...
    .setColor("#26ff0")
    .addField("Zwykłe komendy")
    .setDescription("ab!kolorek - W testach")
    .setDescription("Cześć - Bot ci odpowiada")
    .setDescription("ab!witam - Witasz sie z botem")
    .setDescription("ab!zapros - Zapros mnie na twój serwer")
    .setDescription("ab!powiedz <tekst> - Powiedz coś botem")
    .addField("FUNowskie komendy")
    .setDescription("... - Sam zobaczysz o co chodzi")
    .setDescription("jaki kozak - Sam zobaczysz")
    .setDescription("xd - Bot cie uczy jak pisać słowo xd")
    .setDescription("Ty no nie wiem - Bot dokańcza za ciebie")
    .setDescription("Ty no nie wiem - Bot dokańcza za ciebie")
    .setDescription("lol - Świetnie sie bawisz?")
    .setDescription("lenny - Coś fajnego ( ͡° ͜ʖ ͡°)")
    .setDescription("")
    .addField("Komendy informacyjne")
    .setDescription("ab!report <gracz> <powód> - Zgłoś złamanie regulaminu, wymaga kanału #zgloszenia")
    .setDescription("ab!serwer - Info o serwerze")
    .setDescription("ab!bot - Info o bocie")
    .setDescription("ab!propozycja <tekst> - Zaproponuj coś do wykorzystania na serwerze, wymaga kanału #propozycje")
    .setDescription("ab!creditsy - Czyli ogólnie podziękowania itd")
